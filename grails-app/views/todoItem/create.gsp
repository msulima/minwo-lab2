...
<html>
	...
	<body>
		<a href="#create-todoItem" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-todoItem" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:todoItemInstance, action:'save']" >
				<fieldset class="form">
